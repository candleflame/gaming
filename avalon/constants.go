...
const (
	...
	ACTION_VOTE          Action = 8
	ACTION_NOTIFY_TASK   Action = 9
	ACTION_JUDGE_RESULT  Action = 10
)
...
const (
	...
	STAGE_NOTIFY_TASK    Stage = 5
	STAGE_VOTE_FOR_TASK  Stage = 6
	STAGE_JUDGE_RESULT   Stage = 7
	STAGE_END            Stage = 8
	STAGE_KILL_MERLIN    Stage = 9
)
